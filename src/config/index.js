...
// 全局设置
  ...
  host: process.env.NODE_ENV !== 'production' ? `/xplus_wap` : process.env.NODE_PRODTYPE !== 'production' ? this.devApi : this.productApi,
  websocketUrl: process.env.NODE_ENV !== 'production' ? this.devWsApi : process.env.NODE_PRODTYPE !== 'production' ? this.devWsApi : this.productWsApi
}
