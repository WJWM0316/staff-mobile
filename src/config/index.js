...
// 全局设置
  ...
  oauthUrl: process.env.NODE_ENV !== 'production' ? `https://admin-api.xplus.ziwork.com` : process.type !== 'production' ? `https://admin-api.xplus.ziwork.com` : 'https://admin-api.xplus.xiaodengta.com', // 授权链接
