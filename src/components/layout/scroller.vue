...
<!--         <div class="pulldown-tip" :class="{'showStatus' : pulldownUi}" v-if="pulldown">
          <img class="pull-icon" src="../../assets/icon/loading.png" alt="">
        </div> -->
        <div class="content">
          <slot></slot>
        </div>
        <!-- <div class="loading-pos" v-if="pullup" >
          <div class="loading-container" v-if="!noData" :class="{'pullupUi' : pullupUi}">
