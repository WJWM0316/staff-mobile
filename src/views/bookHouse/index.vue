<template>
  <div class="bookHouse">
    ...
    <div class="allList" v-show="tabIndex === 1">
      <bookCard class="item border-bottom-1px" v-for="item in allData.list" :key='item.bookId' :cardData="item" :type="0"></bookCard>
      <pullUpUi v-if="tabIndex === 1" :noData="allData.noData" :pullUpStatus="allData.pullUpStatus" @pullUp="pullUp" :key='2'></pullUpUi>
